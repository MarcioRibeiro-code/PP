...
public class Accident_ extends Event implements Accident {
    ...
    private Employee Injured_Employee;
    ...
    public Accident_(Employee Employee, ConstructionSite ConstructionSite, String Details, String NotificationMessage, EventPriority priority, String title, Employee reporter) {
        ...
        this.Injured_Employee = Employee;
    ...
    /**
     * Returns the Employee injuried.
     *
     * @return Employee - Employee injuried.
     */
    @Override
    public Employee getEmployee() {
        return this.Injured_Employee;
    }
    ...
    /**
     * Returns the JSON.STRING representation of Accident.
     *
     * @return String - JSON.STRING representation of Accident.
     */
    public String Event_toJSON() {
        ...
        event_details.put("eventtype", "Accident");
        ...
        System.out.println(group_details.toJSONString());
